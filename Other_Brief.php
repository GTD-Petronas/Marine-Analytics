...
WHERE INSPECTION_ID='$INSPECTION_ID' AND a.INS_ITEM_ID IN ('17')";
...
<section id="main">
  <div class="container">
    <div class="row">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="form-inline">
              ...
              <div class="form-group mb-2">
                <a href="index.php?page=Other_other" class="bulat bayang"></a>
                <p>&nbsp; Others</br> &nbsp; </br> &nbsp;</p>
              </div>
              <div class="form-group mb-2">
                <div class="rectangle"></div>
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
              <li class="nav-item ">
                <a class="nav-link  border" id="pills-home-tab"  href="index.php?page=Other_other" role="tab" aria-controls="pills-other" aria-selected="true" style="font-size: 11px; border:solid">Other Findings</a>
              </li>
              <li class="nav-item active">
                <a class="nav-link border" id="pills-profile-tab"  href="index.php?page=Other_Brief" role="tab" aria-controls="pills-Brief" aria-selected="false" style="font-size: 11px; border:solid">Briefing</a>
              </li>
              <li class="nav-item">
                <a class="nav-link border" id="pills-contact-tab"  href="index.php?page=Other_Positive" role="tab" aria-controls="pills-Positive" aria-selected="false" style="font-size: 11px; border:solid">Positive Findings</a>
              </li>
              <!-- <li class="nav-item">
            ...
            <form action="Other_Brief_ps.php" method="POST" enctype="multipart/form-data">
                  ...
                  <table id="dataTable_ovid" class="table table-bordered table-responsive">
                    ...
                    if(!empty($count)){
                      ...
                      while( $row = sqlsrv_fetch_array( $stmtInspectionI, SQLSRV_FETCH_ASSOC) ) {
                        ...
                        echo'
                        <tr>
                        <td><textarea name="findings_Brief[]"  id="finding_Brief'.$row['FINDINGS_ID'].'" cols="65">'.$row['FINDINGS'].'</textarea></td>
                        <td><select id="status_Brief'.$row['FINDINGS_ID'].'" name="status_Brief[]">
                        <option value=""></option>';
                        ...
                        <td><select id="time_frame_Brief'.$row['FINDINGS_ID'].'" name="time_frame_Brief[]">
                        <option value=""></option>';
                      ...
                      ?>
                      <tr>
                        <td><textarea name="findings_Brief[]"  cols="65"></textarea></td>
                        <td><select id="status_Brief[]" name="status_Brief[]">
                          <option value=""></option>
                          <?php
                          $sql="SELECT * FROM MarSIS_MDM_Status WHERE STATUS_ID IN ('2','3')";
                          $stmt = sqlsrv_query( $conn, $sql);
                      ...
                      <td><select id="time_frame" name="time_frame_Brief[]">
                        <option value=""></option>
                        <?php
                        $sql1="SELECT * FROM MarSIS_MDM_TimeFrame";
                        $stmt1 = sqlsrv_query( $conn, $sql1);
      ...
      <button onclick="location.href='index.php?page=Other_Positive'" class="btn btn-md pull-right" style="background-color:#40E0D0; margin-right:5px; ">Next</button>
...
function delete_data(finding_id){
  var finding = document.getElementById("finding_Brief"+finding_id).value;
  var time_frame = document.getElementById("time_frame_Brief"+finding_id).value;
  var status = document.getElementById("status_Brief"+finding_id).value;
  var type = 1; //delete
  ...
  xmlhttp.open("GET","Other_Brief_ps.php?finding_id="+ finding_id + "&type="+type + "&finding="+finding + "&time_frame="+time_frame + "&status="+status,true);
  xmlhttp.send();
}
</script>
