...
WHERE INSPECTION_ID='$INSPECTION_ID' AND a.INS_ITEM_ID IN ('2')";
      ...
      <div class="col-md-10">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <form action="HSE1_tod_edit_ps.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="table-responsive">
                  ...
                  <table id="dataTable_ovid" class="table table-bordered table-responsive">
                    ...
                    if(!empty($count)){
                      ...
                      ?>
                      <tr>
                        <td><textarea name="findings_tod[]"  cols="50"></textarea></td>
                        <td><select id="pax" name="pax_no_tod[]" class="1-100"></select>
                        </td>
                        <td><select id="status" name="status_tod[]">
                          <option value=""></option>
                          <?php
                      ...
                      <td><select id="time_frame" name="time_frame_tod[]">
                        <option value=""></option>
                        <?php
                        $sql1="SELECT * FROM MarSIS_MDM_TimeFrame";
                        $stmt1 = sqlsrv_query( $conn, $sql1);
...
function delete_data(finding_id){
  ...
  xmlhttp.open("GET","HSE1_tod_edit_ps.php?finding_id="+ finding_id + "&type="+type + "&finding="+finding + "&time_frame="+time_frame + "&status="+status +"&pax="+pax,true);
  xmlhttp.send();
}
</script>
