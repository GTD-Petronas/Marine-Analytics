...
WHERE INSPECTION_ID='$INSPECTION_ID' AND a.INS_ITEM_ID IN ('1')";
...
<section id="main">
  <div class="container">
    <div class="row">
      <div class="col-md-10">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <form action="HSE1_ovid_edit_ps.php" method="POST" enctype="multipart/form-data">
                  ...
                  <table id="dataTable_ovid" class="table table-bordered table-responsive">
                    ...
                    if(!empty($count)){
                      ...
                      while( $row = sqlsrv_fetch_array( $stmtInspectionI, SQLSRV_FETCH_ASSOC) ) {
                        ...
                        <td><select id="time_frame_ovid'.$row['FINDINGS_ID'].'" name="time_frame_ovid[]">
                        <option value=""></option>';
      ...
      <button onclick="location.href='index.php?page=HSE1_tod_edit'" class="btn btn-md pull-right" style="background-color:#40E0D0; margin-right:5px; ">Next</button>
...
function delete_data(finding_id){
  var finding = document.getElementById("finding_ovid"+finding_id).value;
  var time_frame = document.getElementById("time_frame_ovid"+finding_id).value;
  var status = document.getElementById("status_ovid"+finding_id).value;
  var type = 1; //delete
  ...
  xmlhttp.open("GET","HSE1_ovid_edit_ps.php?finding_id="+ finding_id + "&type="+type + "&finding="+finding + "&time_frame="+time_frame + "&status="+status,true);
  xmlhttp.send();
}
</script>
