...
WHERE INSPECTION_ID='$INSPECTION_ID' AND a.INS_ITEM_ID IN ('5')";
...
<section id="main">
  <div class="container">
    <div class="row">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="form-inline">
              ...
              <div class="form-group mb-2">
                <a href="index.php?page=HSE1_ovid_edit" class="bulat bayang"></a>
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <ul class="nav nav-pills mb-4" id="pills-tab" role="tablist">
              <li class="nav-item ">
                <a class="nav-link  border" id="pills-home-tab"  href="index.php?page=HSE1_ovid_edit" role="tab" aria-controls="pills-ovid" aria-selected="true" style="font-size: 11px; border:solid">OVID</a>
              </li>
              <li class="nav-item">
                <a class="nav-link border" id="pills-profile-tab"  href="index.php?page=HSE1_tod_edit" role="tab" aria-controls="pills-tod" aria-selected="false" style="font-size: 11px; border:solid">Tour of Duty (TOD)</a>
              </li>
              <li class="nav-item">
                <a class="nav-link border" id="pills-contact-tab"  href="index.php?page=HSE1_osis_edit" role="tab" aria-controls="pills-osis" aria-selected="false" style="font-size: 11px; border:solid">Offshore Safety Passport (OSP) </br>& Contractor Competency Card (CCC)</a>
              </li>
              <li class="nav-item">
                <a class="nav-link border" id="pills-contact-tab"  href="index.php?page=HSE1_fuel_edit" role="tab" aria-controls="pills-fuel" aria-selected="false" style="font-size: 11px; border:solid">Fuel Oil Flow Meter</a>
              </li>
              <li class="nav-item active">
                <a class="nav-link border" id="pills-contact-tab"  href="index.php?page=HSE1_cctv_edit" role="tab" aria-controls="pills-cctv" aria-selected="false" style="font-size: 11px; border:solid">CCTV</a>
              </li>
              <li class="nav-item">
                <a class="nav-link border" id="pills-contact-tab"  href="index.php?page=HSE1_vts_edit" role="tab" aria-controls="pills-vts" aria-selected="false" style="font-size: 11px; border:solid">AIS</a>
              </li>
              <li class="nav-item">
                <a class="nav-link border" id="pills-contact-tab"  href="index.php?page=HSE1_fifi_edit" role="tab" aria-controls="pills-fifi" aria-selected="false" style="font-size: 11px; border:solid">FiFi</a>
              </li>
            </ul>

            <form action="HSE1_cctv_edit_ps.php" method="POST" enctype="multipart/form-data">
                  ...
                  <table id="dataTable_ovid" class="table table-bordered table-responsive">
                    ...
                    if(!empty($count)){
                      ...
                      while( $row = sqlsrv_fetch_array( $stmtInspectionI, SQLSRV_FETCH_ASSOC) ) {
                        ...
                        echo'
                        <tr>
                        <td><textarea name="findings_cctv[]"  id="finding_cctv'.$row['FINDINGS_ID'].'" cols="65">'.$row['FINDINGS'].'</textarea></td>
                        <td><select id="status_cctv'.$row['FINDINGS_ID'].'" name="status_cctv[]">
                        <option value=""></option>';
                        ...
                        <td><select id="time_frame_cctv'.$row['FINDINGS_ID'].'" name="time_frame_cctv[]">
                        <option value=""></option>';
                      ...
                      ?>
                      <tr>
                        <td><textarea name="findings_cctv[]" style="border:none;" cols="65"></textarea></td>
                        <td><select id="status_ovid[]" name="status_cctv[]">
                          <option value=""></option>
                          <?php
                          $sql="SELECT * FROM MarSIS_MDM_Status WHERE STATUS_ID IN ('2','3')";
                          $stmt = sqlsrv_query( $conn, $sql);
                      ...
                      <td><select id="time_frame" name="time_frame_cctv[]">
                        <option value=""></option>
                        <?php
                        $sql1="SELECT * FROM MarSIS_MDM_TimeFrame";
                        $stmt1 = sqlsrv_query( $conn, $sql1);
      ...
      <button onclick="location.href='index.php?page=HSE1_vts_edit'" class="btn btn-md pull-right" style="background-color:#40E0D0; margin-right:5px; ">Next</button>
...
function delete_data(finding_id){
  var finding = document.getElementById("finding_cctv"+finding_id).value;
  var time_frame = document.getElementById("time_frame_cctv"+finding_id).value;
  var status = document.getElementById("status_cctv"+finding_id).value;
  var type = 1; //delete
  ...
  xmlhttp.open("GET","HSE1_cctv_edit_ps.php?finding_id="+ finding_id + "&type="+type + "&finding="+finding + "&time_frame="+time_frame + "&status="+status,true);
  xmlhttp.send();
}
</script>
