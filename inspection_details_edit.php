...
if(!empty($_SESSION['inspection_id_edit'])){
  $INSPECTION_ID_edit_data=$_SESSION['inspection_id_edit'];
}else{
  @$INSPECTION_ID_edit=$_GET['inspec_id'];
    $_SESSION['inspection_id_edit'] = $INSPECTION_ID_edit;
  $INSPECTION_ID_edit_data=$_SESSION['inspection_id_edit'];
}
  ...
  WHERE INSPECTION_ID = '$INSPECTION_ID_edit_data'";
    ...
    <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="form-inline">
              ...
              <div class="form-group mb-2">
                <a href="index.php?page=inspection_details_edit" class="bulat bayang"></a>
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <form action="inspection_details_edit_ps.php" method="POST" autocomplete="off">
            <input type="hidden" class="form-control" id="vessel_id" name="vessel_id" value="<?php echo @$row['VESSEL_ID'] ?>">


              <input type="hidden" class="form-control" id="inspection_id" name="inspection_id" value="<?php echo $INSPECTION_ID_edit_data; ?>">
            ...
            <div class="row">
              <div class="col-md-6 form-group">
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <input type="date" class="form-control"  name="inspection_date" value="<?php echo @date_format($inspection_date, 'Y-m-d') ?>">
                  </div>
                </div>
              </div>
              <div class="col-md-6 form-group">
