      ...
      <div class="col-md-10">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <form action="HSE1_tod_ps.php" method="POST" enctype="multipart/form-data">
                  ...
                  <table id="dataTable_ovid" class="table table-bordered table-responsive">
                    ...
                    if(!empty($count)){
                      ...
                      while( $row = sqlsrv_fetch_array( $stmtInspectionI, SQLSRV_FETCH_ASSOC) ) {
                        ...
                        <td><select id="status_tod'.$row['FINDINGS_ID'].'" name="status_tod[]">
                        <option value=""></option>';
                      ...
                      <tr>
                        ...
                        <td><select id="pax" name="pax_no_tod[]" class="0-100"></select>
                        </td>
        ...
        <button formaction="index.php?page=HSE1_osis" class="btn btn-md pull-right" style="background-color:#40E0D0;">Next</button>
...
function delete_data(finding_id){
  ...
  xmlhttp.open("GET","HSE1_tod_ps.php?finding_id="+ finding_id + "&type="+type + "&finding="+finding + "&time_frame="+time_frame + "&status="+status +"&pax="+pax,true);
  xmlhttp.send();
}
</script>
