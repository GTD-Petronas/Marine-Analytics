        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="form-inline">
              ...
              <div class="form-group mb-2">
                <a href="index.php?page=review_submit" class="bulat bayang"></a>
          ...
          <div class="card">
            ...
            <div id="collapseThree" class="collapse " aria-labelledby="headingThree" data-parent="#accordionExample">
              ...
              <div class="card">
                ...
                <button onclick="window.location.href = 'index.php?page=corrective_action_plan';" type="submit" style="background-color:#40E0D0" class="btn btn-info btn-md pull-right">
