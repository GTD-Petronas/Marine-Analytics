...
WHERE INSPECTION_ID='$INSPECTION_ID' AND a.INS_ITEM_ID IN ('12')";
...
<section id="main">
  <div class="container">
    <div class="row">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="form-inline">
              ...
              <div class="form-group mb-2">
                <a href="index.php?page=HSE2_LSA_edit" class="bulat bayang"></a>
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
              <li class="nav-item ">
                <a class="nav-link border" id="pills-home-tab"  href="index.php?page=HSE2_LSA_edit" role="tab" aria-controls="pills-LSA" aria-selected="true" style="font-size: 11px; border:solid">Life Saving </br> Appliances (LSA)</a>
              </li>
              <li class="nav-item">
                <a class="nav-link border" id="pills-profile-tab"  href="index.php?page=HSE2_FFA_edit" role="tab" aria-controls="pills-FFA" aria-selected="false" style="font-size: 11px; border:solid">Fire Fighting </br> Appliances (FFA)</a>
              </li>
              <li class="nav-item">
                <a class="nav-link border" id="pills-contact-tab"  href="index.php?page=HSE2_Load_edit" role="tab" aria-controls="pills-Load" aria-selected="false" style="font-size: 11px; border:solid">Load Line Items</a>
              </li>
              <li class="nav-item">
                <a class="nav-link border" id="pills-contact-tab"  href="index.php?page=HSE2_PG_edit" role="tab" aria-controls="pills-PG" aria-selected="false" style="font-size: 11px; border:solid">(Procedures </br>& Guidelines) P&G</a>
              </li>
              <li class="nav-item active">
                <a class="nav-link border" id="pills-contact-tab"  href="index.php?page=HSE2_Commu_edit" role="tab" aria-controls="pills-Commu" aria-selected="false" style="font-size: 11px; border:solid">Communication</a>
              </li>
              <li class="nav-item ">
                <a class="nav-link border" id="pills-contact-tab"  href="index.php?page=HSE2_Quart_edit" role="tab" aria-controls="pills-Quart" aria-selected="false" style="font-size: 11px; border:solid">Quarterly </br>Self-Assessment</a>
              </li>
              <li class="nav-item">
                <a class="nav-link border" id="pills-contact-tab"  href="index.php?page=HSE2_Hull_edit" role="tab" aria-controls="pills-Hull" aria-selected="false" style="font-size: 11px; border:solid">Hull &</br> Machineries</a>
              </li>
              <li class="nav-item">
                <a class="nav-link border" id="pills-contact-tab"  href="index.php?page=HSE2_Navi_edit" role="tab" aria-controls="pills-Navi" aria-selected="false" style="font-size: 11px; border:solid">Navigation</a>
              </li>
            </ul>

            <form action="HSE2_Commu_edit_ps.php" method="POST" enctype="multipart/form-data">
                  ...
                  <table id="dataTable_ovid" class="table table-bordered table-responsive">
                    ...
                    if(!empty($count)){
                      ...
                      while( $row = sqlsrv_fetch_array( $stmtInspectionI, SQLSRV_FETCH_ASSOC) ) {
                        ...
                        echo'
                        <tr>
                        <td><textarea name="findings_Commu[]"  id="finding_Commu'.$row['FINDINGS_ID'].'" cols="65">'.$row['FINDINGS'].'</textarea></td>
                        <td><select id="status_Commu'.$row['FINDINGS_ID'].'" name="status_Commu[]">
                        <option value=""></option>';
                        ...
                        <td><select id="time_frame_Commu'.$row['FINDINGS_ID'].'" name="time_frame_Commu[]">
                        <option value=""></option>';
                      ...
                      ?>
                      <tr>
                        <td><textarea name="findings_Commu[]"  cols="65"></textarea></td>
                        <td><select id="status_Commu[]" name="status_Commu[]">
                          <option value=""></option>
                          <?php
                          $sql="SELECT * FROM MarSIS_MDM_Status WHERE STATUS_ID IN ('2','3')";
                          $stmt = sqlsrv_query( $conn, $sql);
                      ...
                      <td><select id="time_frame" name="time_frame_Commu[]">
                        <option value=""></option>
                        <?php
                        $sql1="SELECT * FROM MarSIS_MDM_TimeFrame";
                        $stmt1 = sqlsrv_query( $conn, $sql1);
      ...
      <button onclick="location.href='index.php?page=HSE2_Quart_edit'" class="btn btn-md pull-right" style="background-color:#40E0D0; margin-right:5px; ">Next</button>
...
function delete_data(finding_id){
  var finding = document.getElementById("finding_Commu"+finding_id).value;
  var time_frame = document.getElementById("time_frame_Commu"+finding_id).value;
  var status = document.getElementById("status_Commu"+finding_id).value;
  var type = 1; //delete
  ...
  xmlhttp.open("GET","HSE2_Commu_edit_ps.php?finding_id="+ finding_id + "&type="+type + "&finding="+finding + "&time_frame="+time_frame + "&status="+status,true);
  xmlhttp.send();
}
</script>
